      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-6 text-left">
            <p className="text-gray-700 leading-[1.7] text-base md:text-lg">
              大学を卒業後、新規事業支援のコンサル会社に入社。<br></br>
              エンジニアとして、クラウドファンディングシステムや行政向けサービス、新規SaaSの立ち上げなど多様なプロジェクトを経験。
            </p>
            <p className="text-gray-700 leading-[1.7] text-base md:text-lg">
              現在はフリーランスとして、プライム上場企業や大手メディア企業のシステム開発に携わる傍ら、中小企業向けにAI活用・システム開発・HP制作／保守運用をワンストップで提供しています。
            </p>
                ...
                <div className="px-8 pt-10 pb-10">
                  ...
                  <div className="space-y-6">
                    <p className="text-gray-700 leading-[1.9] text-base">
                      「人の役に立ちたい」という原点から福祉系大学に進学し、社会福祉士を取得。また、学生時代に独学でプログラミングを始め、「技術の力ならもっと多くの人の役に立てる」と確信し、ITの世界へ。
                      <br></br>
                      在学中から複数のスタートアップでエンジニアインターンを経験。趣味では、プログラミング技術をビジネスに活かすアイデアや実装力を競う大会（ハッカソン・アイデアソン）にも積極的に参加してきました。（
                      <a

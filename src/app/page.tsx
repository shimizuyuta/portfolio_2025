  ...
  return (
    <main className="">
      ...
      >
            ...
            <div className="flex-1 text-left relative z-10">
              ...
              <div className="space-y-2 sm:space-y-3 md:space-y-4 mb-6 md:mb-10 text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed">
                ...
                <p className="hidden sm:block text-gray-800">
                  AI・DXサポート、ウェブ開発、マーケティング支援を通じて
                </p>
                <p className="hidden sm:block text-gray-800">
                  中小企業や個人事業主をサポートしています。
                </p>
                <p className="sm:hidden text-gray-800">
                  AI・DX・ウェブ開発・マーケティング支援で中小企業をサポート
                </p>
              </div>
            </div>
        ...
        <div
          className="absolute top-20 right-10 w-16 sm:w-24 md:w-32 h-16 sm:h-24 md:h-32 bg-sky-100 rounded-full opacity-20 blur-2xl md:blur-3xl"
          aria-hidden="true"
        ></div>
        <div
          className="absolute bottom-20 left-10 w-12 sm:w-16 md:w-24 h-12 sm:h-16 md:h-24 bg-cyan-100 rounded-full opacity-20 blur-xl md:blur-2xl"
          aria-hidden="true"
        ></div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6 xl:px-8">
          <h2
            id="services-heading"
            className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-20 text-gray-900"
          >
            Services
          </h2>
            ...
            <Card className="pt-0 overflow-hidden hover:shadow-xl transition-shadow duration-300 bg-white border border-gray-200">
              <div className="relative">
                <div className="w-full h-56 md:h-64 bg-gradient-to-r from-sky-100 to-blue-100 flex items-center justify-center">
                  <div className="text-center">
                    <Brain
                      className="w-16 h-16 md:w-20 md:h-20 text-sky-700 mx-auto mb-4"
                      aria-hidden="true"
                    />
              ...
              <div className="p-6 md:p-8">
                <h3 className="text-xl md:text-2xl font-semibold mb-4 flex items-center gap-3 text-gray-900">
                  <Brain
                    className="w-6 h-6 md:w-7 md:h-7 text-sky-700 flex-shrink-0"
                    aria-hidden="true"
                  />

...
export default function Home() {
  ...
  return (
    <main className="">
      ...
      <motion.section
        id="about"
        className="bg-background max-w-7xl mx-auto py-16 md:py-24 px-6 min-h-screen"
      ...
      <motion.section
        id="pain"
        className="w-full bg-muted py-16 md:py-24 min-h-screen"
      ...
      <motion.section
        id="knowledge"
        className="w-full bg-background py-16 md:py-24 min-h-screen text-center"
      ...
      <motion.section
        id="contact"
        className="w-full bg-muted py-16 md:py-24 min-h-screen text-center"
